// Перед тем, как начать работать, выполните код в консоли.
// mmcore.SetCookie('gm', 2, 30); // ставится кука на 30 дней
//
// Надо привести страницу вида
// http://www.paddypower.it/scommesse-calcio
//
// К виду, как на картинке в текущей папке
...
//
//
// В итоге у вас должен получиться единый файл, содержимое которого надо выполнить в консоли, и получить результат как на изображении.
//
// Все вопросы-ответы - в файле рядом с заданием.
//
//
//
...
var tabs = jQuery('table[id].footballcard ');
