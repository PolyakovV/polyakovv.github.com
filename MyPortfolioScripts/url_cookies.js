...
// Задание в форме бизнес требования:
// Для всех страниц сайта посчитать на какую ссылку пользователь навел мышку, но не кликнул. 
// Надо запомнить как страницу, где действие происходило, так и url ссылки, 
//на которую не был произведен клик. Анализ проводится для всех страниц сайта.
...
// Скрипт должен быть самодостаточным, поддерживать ие8, корректно работать 
//на потенциально любом сайте. В решении прикладывай ссылки на сайты, которые ты протестировал.
...
//  Сделан без jQuery - не на всех страницах подключена библиотека.
